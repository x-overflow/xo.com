...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '🎉 X Overflow beta launched.',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Fred Magnus', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Data and information specialists, lifelong learners, PKM and daily iteration enthusiasts.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Software Review,Software Recommendation, Knowledge Management, Digital Garden, PKM, Tana, Obsidian, Notion, Coda, Note-taking, ROAM, AnyType, Capacities', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'fomalhaut[at]gmail.com', // 邮箱地址 例如mail@tangly1024.com
